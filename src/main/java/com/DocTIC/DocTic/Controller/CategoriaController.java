...
public class CategoriaController {
    ...
    @PutMapping("/editar")
    public ResponseEntity<String> editarCategoria(@RequestBody CategoriaModel CategoriaModel){
        return new ResponseEntity<String>(categoriaService.editarCategoria(CategoriaModel), HttpStatus.OK);
